...
es0 f22 type einbuergerung_Gruppe6.eroeffnenEinwaende.eroeffnenEinwaendeData #txt
...
es0 f23 type einbuergerung_Gruppe6.eroeffnenEinwaende.eroeffnenEinwaendeData #txt
...
es0 f25 actionDecl 'einbuergerung_Gruppe6.eroeffnenEinwaende.eroeffnenEinwaendeData out;
' #txt
es0 f25 actionTable 'out=in;
out.request.objections=in.request.objections.remove(in.selectedObjection);
' #txt
es0 f25 type einbuergerung_Gruppe6.eroeffnenEinwaende.eroeffnenEinwaendeData #txt
