...
@javax.annotation.Generated(comments="This is the java file of the ivy data class dokumente_pruefenData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class dokumente_pruefenData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
